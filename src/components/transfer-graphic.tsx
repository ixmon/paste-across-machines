...
export function TransferGraphic({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      >
        <defs>
          <linearGradient id="paste-arc" x1="148" y1="72" x2="252" y2="72" gradientUnits="userSpaceOnUse">
            <stop stopColor="var(--accent-tangerine)" />
            <stop offset="0.5" stopColor="var(--accent-purple)" />
            <stop offset="1" stopColor="var(--accent-scale)" />
          </linearGradient>
        </defs>
        {/* Soft ground wash */}
        ...
        <g transform="translate(28, 36)">
          ...
          {/* Selection highlight */}
          <rect x="24" y="26" width="52" height="11" rx="2" fill="var(--accent-tangerine)" opacity="0.22" />
          {/* Base */}
          <path
        ...
        <g transform="translate(262, 36)">
          ...
          <rect x="16" y="16" width="94" height="52" rx="3" fill="var(--color-bg)" />
          {/* Same text arriving */}
          <rect x="24" y="26" width="52" height="3" rx="1.5" fill="var(--accent-scale)" opacity="0.85" />
          <rect x="24" y="34" width="70" height="3" rx="1.5" fill="var(--color-fg-subtle)" opacity="0.45" />
          <rect x="24" y="42" width="44" height="3" rx="1.5" fill="var(--color-fg-subtle)" opacity="0.35" />
          <rect x="24" y="50" width="60" height="3" rx="1.5" fill="var(--color-fg-subtle)" opacity="0.3" />
          <rect x="24" y="24" width="52" height="8" rx="2" fill="var(--accent-scale)" opacity="0.16" />
          <path
            d="M0 86h126c2 0 4 2 4 4v4H-4v-4c0-2 2-4 4-4z"
            fill="var(--color-surface-2)"
            stroke="var(--color-border)"
        ...
        <g transform="translate(176, 28)">
          <rect
            ...
            strokeWidth="1.5"
          />
          <rect x="14" y="2" width="20" height="12" rx="3" fill="var(--accent-purple)" />
          <rect x="18" y="5" width="12" height="6" rx="2" fill="var(--color-bg)" opacity="0.9" />
